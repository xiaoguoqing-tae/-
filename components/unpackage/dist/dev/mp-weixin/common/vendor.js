...
/***/ 21:
/*!**************************************!*\
  !*** E:/uni-app/store/apis/index.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.delorder = exports.getorder = exports.createorder = exports.addaddress = exports.getaddress = exports.getcartinfo = exports.removecartinfo = exports.updatecart = exports.joincart = exports.detail = exports.goods = exports.sorts = exports.getIndex = void 0;var getIndex = function getIndex(params) {return (
    //首页列表
    uni.request({
...
var sorts = function sorts(params) {return (
    //商品类别
    uni.request({
      url: "https://api.it120.cc/tae/shop/goods/category/all",
      data: params,
      header: {
        "content-type": "json" } }));};exports.sorts = sorts;



var goods = function goods(id) {return (
    //商品列表
    uni.request({
      url: "https://api.it120.cc/tae/shop/goods/list?categoryId=" + id,
      header: {
        "content-type": "json" } }));};exports.goods = goods;



var detail = function detail(id) {return (
    //商品详情
    uni.request({
      url: "https://api.it120.cc/tae/shop/goods/detail?id=" + id,
      header: {
        "content-type": "json" } }));};exports.detail = detail;



var joincart = function joincart(params) {return (
    //加入购物车
    uni.request({
      ...
      method: 'POST',
      header: {
        "content-type": "application/x-www-form-urlencoded" } }));};exports.joincart = joincart;



var updatecart = function updatecart(params) {return (
    //修改购物车数据
    uni.request({
      ...
      method: 'POST',
      header: {
        "content-type": "application/x-www-form-urlencoded" } }));};exports.updatecart = updatecart;



var removecartinfo = function removecartinfo(params) {return (
    //移除一条购物车数据
    uni.request({
      ...
      method: 'POST',
      header: {
        "content-type": "application/x-www-form-urlencoded" } }));};exports.removecartinfo = removecartinfo;



var getcartinfo = function getcartinfo(token) {return (
    //获取购物车数据
    uni.request({
      url: "https://api.it120.cc/tae/shopping-cart/info?token=" + token,
      header: {
        "content-type": "json" } }));};exports.getcartinfo = getcartinfo;



var getaddress = function getaddress(params) {return (
    //获取地址
    uni.request({
      url: "https://api.it120.cc/tae/user/shipping-address/list",
      data: params,
      header: {
        "content-type": "x-www-form-urlencoded" } }));};exports.getaddress = getaddress;



var addaddress = function addaddress(params) {return (
    //添加地址
    uni.request({
      url: "https://api.it120.cc/tae/user/shipping-address/add",
      data: params,
      header: {
        "content-type": "x-www-form-urlencoded" } }));};exports.addaddress = addaddress;
...
var getorder = function getorder(params) {return (
    //获取订单
    uni.request({
      url: "https://api.it120.cc/tae/order/list",
      data: params,
      header: {
        "content-type": "x-www-form-urlencoded" } }));};exports.getorder = getorder;



var delorder = function delorder(params) {return (
    //删除订单
    uni.request({
      url: "https://api.it120.cc/tae/order/delete",
      data: params,
      header: {
        "content-type": "x-www-form-urlencoded" } }));};exports.delorder = delorder;
...
/***/ 64:
/*!***************************************************************************!*\
  !*** E:/uni-app/store/node_modules/apifm-wxapi/miniprogram_dist/index.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!****************************************************!*\
  !*** E:/uni-app/store/pages.json?{"type":"style"} ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/home/home": { "navigationBarTitleText": "首页" }, "pages/cart/cart": { "navigationBarTitleText": "购物车" }, "pages/product/product": { "navigationBarTitleText": "商品" }, "pages/user/user": { "navigationBarTitleText": "我的" }, "pages/goods/goods": {}, "pages/login/login": {}, "pages/register/register": {}, "pages/address/address": {}, "pages/addaddress/addaddress": {}, "pages/order/order": {}, "pages/orderlist/orderlist": {} }, "globalStyle": {} };exports.default = _default;

/***/ }),

/***/ 8:
/*!***************************************************!*\
  !*** E:/uni-app/store/pages.json?{"type":"stat"} ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
