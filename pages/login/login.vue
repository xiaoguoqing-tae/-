	...
	<view>
		...
		<view class="login-form">
			<form @submit="formSubmit()"> 
				...
				<view class="form-input">
					<input type="password" v-model="form.pwd" placeholder="密码" @focus="passwordF_B" @blur="passwordF_B" />
				</view>
				<button type="primary" form-type="submit">登录</button>
				<button style="margin-top: 50upx;" type="primary" @click="register">去注册</button>
			</form>
		</view>
	</view>
</template>
